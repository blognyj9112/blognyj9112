...
$(document).ready(function(){
	...
	function SearchWeek(){
		...
		console.log("endDate:"+endDate);
		console.log("startDate:"+startDate);
		location.href="${pageContext.request.contextPath}/deleteGroupListSearch?startDate="+startDate+"&&endDate="+endDate; 
	}
	//1개월전 검색
		...
		<div class="main-panel">
			...
			<!-- 기간 검색 -->   	
				<div class="form-inline" style="float:left;">
					<form class="form-inline" id="formSearch" name="formSearch" onsubmit="return formSearchcheck()" action="${pageContext.request.contextPath}/deleteGroupListSearch" method="POST"> 
						...
						<div class="form-group">
							<input type="button" class="btn btn-sm btn-primary" onclick="deleteGroupListAll()" value="전체보기">	
						</div>				
					</form>
				</div>
				<!-- 일반 검색 -->
				<div class="form-inline pull-right">
				 	<form class="form-inline" id="formSearchKeyword" name="formSearchKeyword" onsubmit="return formSearchKeywordcheck()" action="${pageContext.request.contextPath}/deleteGroupListKeywordSearch" method="post">
						<select class="form-control" name="keyOption" size="1">
				            ...
				            <option value="groupKindName" <c:if test="${'groupKindName'==keyOption }"> selected</c:if>>그룹생설일</option>
				        </select>
				...
				<div class="navbar-form navbar-left">
					<div  class="form-group" style="margin:0px">
						<input type="button" class="btn btn-primary" onclick="deleteGroupcheckCancle()" value="삭제취소">
					</div>
				</div>
				<div class="navbar-form navbar-right">
					<div class="form-group" style="margin:0px">
						<input type="button" class="btn btn-primary" onclick="groupMainBtn()" value="그룹메인">
						<input type="button" class="btn btn-primary" onclick="groupListBtn()" value="그룹리스트">
					</div>
				</div>
				<div align="center">
					<nav>
